# -*- coding: utf-8 -*-
"""
Created on Wed Jun  6 19:46:42 2018
...
day_df = day_df_2012 ### Need to change ###
...
y = day_df.cnt # 0.6535791885825518
...
#                  lasso_alpha = 1,
#                  lasso_iter = 5000)
lassoName = Lasso(alpha = 0.1, max_iter = 100000, tol = 1e-20)
...
namesAll = X.columns
lassoAll = Lasso(alpha = 0.1, max_iter = 100000, tol = 1e-20)
...
names = X.columns
lasso = Lasso(alpha = 0.4, max_iter = 100000, tol = 1e-20)
...
# Full model 
Full_df = day_df[['season','holiday', 'weekday',
       'workingday', 'weathersit', 'temp', 'hum', 'windspeed']]
X = Full_df
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.3  , random_state =42)

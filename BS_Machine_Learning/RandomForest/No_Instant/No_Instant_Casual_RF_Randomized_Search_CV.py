...
Skype_Editing_Registered_RF_Randomized_Search_CV
...
print('\n')
print('Casual_RF_Randomized_Search_CV')
print('\n')
...
# Graph labels
plt.xlabel('Instant'); plt.ylabel('Casual Riders'); plt.title('Actual and Predicted Values of First Forest');
plt.show()
plt.clf()
...
#
# =============================================================================
# RandomForestRegressor(bootstrap=False, criterion='mse', max_depth=87,
...
# Graph labels
plt.xlabel('Instant'); plt.ylabel('Casual Riders'); plt.title('Searched Param Actual and Predicted Values');
plt.show()
plt.clf()
...
print('Improvement: ', r_improvement)
# R^2:  0.847465781857

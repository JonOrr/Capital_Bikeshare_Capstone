# -*- coding: utf-8 -*-
"""
Created on Tue Jun 12 14:10:33 2018
...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 12 14:08:53 2018
...
print('\n')
print('Total Users 2012 Randomized Search CV')
print('\n')

No_aTemp = day_df_2012[['instant', 'season', 'mnth', 'holiday', 'weekday',
...
# Graph labels
plt.xlabel('Instant'); plt.ylabel('Maximum Total Riders'); plt.title('Actual and Predicted Values');
plt.show()
plt.clf()
...
# =============================================================================
# # Best param set for random forest regression on Total Users
# =============================================================================
# #
# RandomForestRegressor(bootstrap=False, criterion='mse', max_depth=76,
...
# 
# # Graph labels
# plt.xlabel('Instant'); plt.ylabel('Maximum Total Riders'); plt.title('Searched Param Actual and Predicted Values');
# plt.show()
# plt.clf()
# 
# print('\n')

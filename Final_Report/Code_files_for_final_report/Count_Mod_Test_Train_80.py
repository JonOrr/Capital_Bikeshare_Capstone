# -*- coding: utf-8 -*-
"""
Created on Mon Jun 18 11:37:56 2018

No Instant Count_RF_Randomized_Search_CV 
Modified test / train 80%
...
print('\n')
print('Count_RF_Randomized_Search_CV')
print('\n')
...
# Give the first 658 features predict the last 20%
train_features, test_features, train_labels, test_labels = features[:584, :], features[584:, :], labels[:584], labels[584:]
...
# Graph labels
plt.xlabel('Instant'); plt.ylabel('Total Riders'); plt.title('Actual and Predicted Values of First Forest');
plt.show()
plt.clf()
...
# Graph labels
plt.xlabel('Instant'); plt.ylabel('Total Riders'); plt.title('Searched Param Actual and Predicted Values');
plt.show()
plt.clf()
